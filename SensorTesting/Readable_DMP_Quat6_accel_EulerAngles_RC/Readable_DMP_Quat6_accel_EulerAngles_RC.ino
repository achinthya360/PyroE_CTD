/****************************************************************
 * DMP_Quat6_plus_acceleration_EulerAngles.ino
 * ICM 20948 Arduino Library Demo
 * Initialize the DMP based on the TDK InvenSense ICM20948_eMD_nucleo_1.0 example-icm20948
 * based on Paul Clark and Jon's code, April/May, 2021 from Sparkfun
...
void setup()
{
  ...
  Serial.println("nothing enabled");
...
void loop()
{
   ...
   if (moreData >=0) //function returns -1 if no data was read.
   {
      ...
      String outString = String(newx,4)+","+String(newy,4)+","+String(newz,4);
      Serial.println(outString);// this should be the linear acceleration vector only if done right
   }
